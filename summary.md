...
复赛时官方提供天气数据，遂切换至官方数据。数据包含最低、最高温度、天气。天气数据是文本的类别变量，我们根据晴天体感温度偏高，下雪天体感温度偏低，将天气状况映射成数值变量，映射规则为经过脑补的[weather2val变换](https://github.com/lvniqi/tianchi_power/blob/master/code/weather2val_t.csv)。
